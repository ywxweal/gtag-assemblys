...
public class PhotonSignal<T1, T2, T3, T4> : PhotonSignal
{
	...
	// (get) Token: 0x06003896 RID: 14486 RVA: 0x00110F07 File Offset: 0x0010F107
	...
	// (add) Token: 0x06003897 RID: 14487 RVA: 0x00110F0A File Offset: 0x0010F10A
	// (remove) Token: 0x06003898 RID: 14488 RVA: 0x00110F3E File Offset: 0x0010F13E
	...
	// Token: 0x06003899 RID: 14489 RVA: 0x00110ABB File Offset: 0x0010ECBB
	public PhotonSignal(string signalID)
		: base(signalID)
	{
	}

	// Token: 0x0600389A RID: 14490 RVA: 0x00110AC4 File Offset: 0x0010ECC4
	public PhotonSignal(int signalID)
		: base(signalID)
	{
	}

	// Token: 0x0600389B RID: 14491 RVA: 0x00110F5B File Offset: 0x0010F15B
	...
	// Token: 0x0600389C RID: 14492 RVA: 0x00110F6A File Offset: 0x0010F16A
	public void Raise(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
	{
		this.Raise(this._receivers, arg1, arg2, arg3, arg4);
	}

	// Token: 0x0600389D RID: 14493 RVA: 0x00110F80 File Offset: 0x0010F180
	...
	// Token: 0x0600389E RID: 14494 RVA: 0x0011103C File Offset: 0x0010F23C
	...
	// Token: 0x0600389F RID: 14495 RVA: 0x00111084 File Offset: 0x0010F284
	public new static implicit operator PhotonSignal<T1, T2, T3, T4>(string s)
	{
		return new PhotonSignal<T1, T2, T3, T4>(s);
	}

	// Token: 0x060038A0 RID: 14496 RVA: 0x0011108C File Offset: 0x0010F28C
