...
namespace CjLib
{
	...
	{
		// Token: 0x06005B36 RID: 23350 RVA: 0x001C04E0 File Offset: 0x001BE6E0
		public static float AsinSafe(float x)
		{
			return Mathf.Asin(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x06005B37 RID: 23351 RVA: 0x001C04F7 File Offset: 0x001BE6F7
		public static float AcosSafe(float x)
		{
			return Mathf.Acos(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x06005B38 RID: 23352 RVA: 0x001C0510 File Offset: 0x001BE710
