...
{
	// Token: 0x060029A6 RID: 10662 RVA: 0x000CE880 File Offset: 0x000CCA80
	public float InitTimeOffset()
	{
		return this.startPercentage * this.cycleLength;
	}

	// Token: 0x060029A7 RID: 10663 RVA: 0x000CE88F File Offset: 0x000CCA8F
	private long InitTimeOffsetMs()
	{
		return (long)(this.InitTimeOffset() * 1000f);
	}

	// Token: 0x060029A8 RID: 10664 RVA: 0x000CE89E File Offset: 0x000CCA9E
	...
	// Token: 0x060029A9 RID: 10665 RVA: 0x000CE8C7 File Offset: 0x000CCAC7
	private long CycleLengthMs()
	{
		return (long)(this.cycleLength * 1000f);
	}

	// Token: 0x060029AA RID: 10666 RVA: 0x000CE8D8 File Offset: 0x000CCAD8
	...
	// Token: 0x060029AB RID: 10667 RVA: 0x000CE903 File Offset: 0x000CCB03
	public int CycleCount()
	{
		return (int)(this.NetworkTimeMs() / this.CycleLengthMs());
	}

	// Token: 0x060029AC RID: 10668 RVA: 0x000CE914 File Offset: 0x000CCB14
	...
	// Token: 0x060029AD RID: 10669 RVA: 0x000CE976 File Offset: 0x000CCB76
	public bool CycleForward()
	{
		return (this.CycleCount() + (this.startNextCycle ? 1 : 0)) % 2 == 0;
	}

	// Token: 0x060029AE RID: 10670 RVA: 0x000CE990 File Offset: 0x000CCB90
	private void Awake()
	{
	...
	// Token: 0x060029AF RID: 10671 RVA: 0x000CEA60 File Offset: 0x000CCC60
	...
	// Token: 0x060029B0 RID: 10672 RVA: 0x000CEAE9 File Offset: 0x000CCCE9
	private Vector3 UpdatePointToPoint()
	{
		return Vector3.Lerp(this.startPos, this.endPos, this.smoothedPercent);
	}

	// Token: 0x060029B1 RID: 10673 RVA: 0x000CEB04 File Offset: 0x000CCD04
	...
	// Token: 0x060029B2 RID: 10674 RVA: 0x000CEB62 File Offset: 0x000CCD62
	private Quaternion UpdateRotation()
	{
		return Quaternion.Slerp(this.startRot, this.endRot, this.smoothedPercent);
	}

	// Token: 0x060029B3 RID: 10675 RVA: 0x000CEB7B File Offset: 0x000CCD7B
	...
	// Token: 0x060029B4 RID: 10676 RVA: 0x000CEBA8 File Offset: 0x000CCDA8
	...
	// Token: 0x060029B5 RID: 10677 RVA: 0x000CEC78 File Offset: 0x000CCE78
	private void Update()
	{
		if (this.platformType == MovingPlatform.PlatformType.Child)
		{
	...
	// Token: 0x060029B6 RID: 10678 RVA: 0x000CED99 File Offset: 0x000CCF99
