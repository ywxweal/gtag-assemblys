...
{
	// Token: 0x06001B74 RID: 7028 RVA: 0x00086F73 File Offset: 0x00085173
	...
	// Token: 0x06001B75 RID: 7029 RVA: 0x00086FAD File Offset: 0x000851AD
	...
	// Token: 0x06001B76 RID: 7030 RVA: 0x00086FE7 File Offset: 0x000851E7
	public void OnBiteView(VRRig rig, int nextState)
	{
		this.OnBite(rig, nextState, true);
	}

	// Token: 0x06001B77 RID: 7031 RVA: 0x00086FF2 File Offset: 0x000851F2
	public void OnBiteWorld(VRRig rig, int nextState)
	{
		this.OnBite(rig, nextState, false);
	}

	// Token: 0x06001B78 RID: 7032 RVA: 0x00086FFD File Offset: 0x000851FD
