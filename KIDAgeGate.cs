...
public class KIDAgeGate : MonoBehaviour
{
	...
	// (get) Token: 0x060030CB RID: 12491 RVA: 0x000EFF12 File Offset: 0x000EE112
	...
	// (get) Token: 0x060030CC RID: 12492 RVA: 0x000EFF19 File Offset: 0x000EE119
	// (set) Token: 0x060030CD RID: 12493 RVA: 0x000EFF20 File Offset: 0x000EE120
	public static bool DisplayedScreen { get; private set; }

	// Token: 0x060030CE RID: 12494 RVA: 0x000EFF28 File Offset: 0x000EE128
	private void Awake()
	{
	...
	// Token: 0x060030CF RID: 12495 RVA: 0x000EFF54 File Offset: 0x000EE154
	private async void Start()
	{
	}

	// Token: 0x060030D0 RID: 12496 RVA: 0x000EFF83 File Offset: 0x000EE183
	private void OnDestroy()
	{
		this.requestCancellationSource.Cancel();
	}

	// Token: 0x060030D1 RID: 12497 RVA: 0x000EFF90 File Offset: 0x000EE190
	...
	// Token: 0x060030D2 RID: 12498 RVA: 0x000EFFCC File Offset: 0x000EE1CC
	private async Task StartAgeGate()
	{
		await this.InitialiseAgeGate();
	}

	// Token: 0x060030D3 RID: 12499 RVA: 0x000F0010 File Offset: 0x000EE210
	...
	// Token: 0x060030D4 RID: 12500 RVA: 0x000F0054 File Offset: 0x000EE254
	...
	// Token: 0x060030D5 RID: 12501 RVA: 0x000F0098 File Offset: 0x000EE298
	...
	// Token: 0x060030D6 RID: 12502 RVA: 0x000F00DC File Offset: 0x000EE2DC
	...
	// Token: 0x060030D7 RID: 12503 RVA: 0x000F011F File Offset: 0x000EE31F
	public static void OnConfirmAgePressed(int currentAge)
	{
		KIDAgeGate._hasChosenAge = true;
	}

	// Token: 0x060030D8 RID: 12504 RVA: 0x000F0128 File Offset: 0x000EE328
	private async Task OnAgeGateCompleted()
	{
		this.FinaliseAgeGateAndContinue();
	}

	// Token: 0x060030D9 RID: 12505 RVA: 0x000F016B File Offset: 0x000EE36B
	...
	// Token: 0x060030DA RID: 12506 RVA: 0x000F0190 File Offset: 0x000EE390
	...
	// Token: 0x060030DB RID: 12507 RVA: 0x000F01A4 File Offset: 0x000EE3A4
	...
	// Token: 0x060030DC RID: 12508 RVA: 0x000F01DC File Offset: 0x000EE3DC
	...
	// Token: 0x060030DD RID: 12509 RVA: 0x000023F4 File Offset: 0x000005F4
	private void RefreshChallengeStatus()
	{
	}

	// Token: 0x060030DE RID: 12510 RVA: 0x000F0229 File Offset: 0x000EE429
	public static void SetAgeGateConfig(GetRequirementsData response)
	{
		KIDAgeGate._ageGateConfig = response;
	}

	// Token: 0x060030DF RID: 12511 RVA: 0x000F0234 File Offset: 0x000EE434
	...
	// Token: 0x060030E0 RID: 12512 RVA: 0x000F02C4 File Offset: 0x000EE4C4
	...
	// Token: 0x060030E1 RID: 12513 RVA: 0x000F02F0 File Offset: 0x000EE4F0
